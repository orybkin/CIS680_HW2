...
misc_arg.add_argument('--flip_left_right', type=str2bool, default=True)
misc_arg.add_argument('--normalize_img', type=str2bool, default=True)
misc_arg.add_argument('--pad_and_crop', type=str2bool, default=True)
misc_arg.add_argument('--train_adversarial', type=str2bool, default=False)
misc_arg.add_argument('--test_adversarial', type=str2bool, default=False)

misc_arg.add_argument('--load_path', type=str, default='')
misc_arg.add_argument('--log_step', type=int, default=100)
misc_arg.add_argument('--test_iter', type=int, default=100)
misc_arg.add_argument('--save_step', type=int, default=400)

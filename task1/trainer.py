...
class Trainer(object):
  ...
  def train(self):
    ...
    # im_grad = self.sess.run([self.test_im_grad])
  ...
  def build_model(self):
    ...
    self.c_loss, feat, self.accuracy, self.c_var, self.im_grad = self.model(
  ...
  def build_test_model(self):
    ...
    loss, self.test_feat, self.test_accuracy, var, self.test_im_grad  = self.model(
